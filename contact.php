...
?>
  ...
  <div id="contact">
     ...
     <?php
        ...
        //Check for ['Header Injection'(Hacks)]
        function has_header_injection($str) {
            return preg_match( "/[\r\n]/", $str );
        }
        
       
        // Check to see if ['contact_submit'(button)] was pressed.
        if (isset ($_POST['contact_submit'])) {
            ...
            // Check to see if $name, $email, $msg are empty.
            if ( !$name || !$email || !$msg ) {
                
                // If empty give warning. 
     ...
     <!-- Show Contact form if Submit Button has not been Clicked. -->
